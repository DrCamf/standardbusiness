...
class OrderLineGateway 
{
    ...
    public function Insert(Array $input )
    {
        ...
        {
            $statement = "INSERT INTO `OrderLine`( `amount`, `price`, `order_id`, `item_id`) VALUES (:amount, :price, :orderid, :itemid); ";
            try 
            {
        ...
        {
            $statement = "INSERT INTO `OrderLine`( `amount`, `price`, `order_id`, `item_id`) VALUES";
            foreach ($input as $item) {
                $statement .=  "('" . $item['amount'] . "', '" . $item['price'] . "', '" . $item['orderid'] . "', '" . $item['itemid'] . "')," ;
            }
